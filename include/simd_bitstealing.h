/*
 * simd_bitstealing.h — unified SIMD hash set/map with bit-stealing overflow
 *
...
#error "Define SIMD_MAP_NAME before including simd_bitstealing.h"
#endif
#ifndef SIMD_MAP_KEY_WORDS
#error "Define SIMD_MAP_KEY_WORDS before including simd_bitstealing.h"
#endif
...
/* Validate map-mode requirements */
  ...
  #error "Define SIMD_MAP_LAYOUT (1, 2, or 3) when SIMD_MAP_VAL_WORDS > 0"
  #endif
...
/* --- Common (once) --- */
#ifndef SIMD_BITSTEALING_COMMON_H_
#define SIMD_BITSTEALING_COMMON_H_
